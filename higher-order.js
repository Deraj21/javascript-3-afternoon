...
const calcTax = val => val *= 1.07;
let postTaxPrices = prices.map(calcTax);
...
const calcTotal = (total, item) => total + item;
let totalPopulation = populations.reduce(calcTotal);
...
const cpOver200 = monster => monster.CP > 200;
